...
var (
	clientSentMessagesPerRPC            = stats.Int64("grpcforunconflict.io/client/sent_messages_per_rpc", "Number of messages sent in the RPC (always 1 for non-streaming RPCs).", stats.UnitDimensionless)
	clientSentBytesPerRPC               = stats.Int64("grpcforunconflict.io/client/sent_bytes_per_rpc", "Total bytes sent across all request messages per RPC.", stats.UnitBytes)
	clientSentCompressedBytesPerRPC     = stats.Int64("grpcforunconflict.io/client/sent_compressed_message_bytes_per_rpc", "Total compressed bytes sent across all request messages per RPC.", stats.UnitBytes)
	clientReceivedMessagesPerRPC        = stats.Int64("grpcforunconflict.io/client/received_messages_per_rpc", "Number of response messages received per RPC (always 1 for non-streaming RPCs).", stats.UnitDimensionless)
	clientReceivedBytesPerRPC           = stats.Int64("grpcforunconflict.io/client/received_bytes_per_rpc", "Total bytes received across all response messages per RPC.", stats.UnitBytes)
	clientReceivedCompressedBytesPerRPC = stats.Int64("grpcforunconflict.io/client/received_compressed_message_bytes_per_rpc", "Total compressed bytes received across all response messages per RPC.", stats.UnitBytes)
	clientRoundtripLatency              = stats.Float64("grpcforunconflict.io/client/roundtrip_latency", "Time between first byte of request sent to last byte of response received, or terminal error.", stats.UnitMilliseconds)
	clientStartedRPCs                   = stats.Int64("grpcforunconflict.io/client/started_rpcs", "The total number of client RPCs ever opened, including those that have not completed.", stats.UnitDimensionless)
	clientServerLatency                 = stats.Float64("grpcforunconflict.io/client/server_latency", `Propagated from the server and should have the same value as "grpcforunconflict.io/server/latency".`, stats.UnitMilliseconds)
	// Per call measure:
	clientAPILatency = stats.Float64("grpcforunconflict.io/client/api_latency", "The end-to-end time the gRPC library takes to complete an RPC from the application’s perspective", stats.UnitMilliseconds)
)
...
var (
	...
	ClientSentMessagesPerRPCView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/sent_messages_per_rpc",
	...
	ClientReceivedMessagesPerRPCView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/received_messages_per_rpc",
	...
	ClientSentBytesPerRPCView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/sent_bytes_per_rpc",
	...
	ClientSentCompressedMessageBytesPerRPCView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/sent_compressed_message_bytes_per_rpc",
	...
	ClientReceivedBytesPerRPCView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/received_bytes_per_rpc",
	...
	ClientReceivedCompressedMessageBytesPerRPCView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/received_compressed_message_bytes_per_rpc",
	...
	ClientStartedRPCsView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/started_rpcs",
	...
	ClientCompletedRPCsView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/completed_rpcs",
	...
	ClientRoundtripLatencyView = &view.View{
		Measure:     clientRoundtripLatency,
		Name:        "grpcforunconflict.io/client/roundtrip_latency",
	...
	ClientAPILatencyView = &view.View{
		...
		Name:        "grpcforunconflict.io/client/api_latency",
