...
var (
	serverReceivedMessagesPerRPC        = stats.Int64("grpcforunconflict.io/server/received_messages_per_rpc", "Number of messages received in each RPC. Has value 1 for non-streaming RPCs.", stats.UnitDimensionless) // the collection/measurement point of this measure handles the /rpc aspect of it
	serverReceivedBytesPerRPC           = stats.Int64("grpcforunconflict.io/server/received_bytes_per_rpc", "Total bytes received across all messages per RPC.", stats.UnitBytes)
	serverReceivedCompressedBytesPerRPC = stats.Int64("grpcforunconflict.io/server/received_compressed_bytes_per_rpc", "Total compressed bytes received across all messages per RPC.", stats.UnitBytes)
	serverSentMessagesPerRPC            = stats.Int64("grpcforunconflict.io/server/sent_messages_per_rpc", "Number of messages sent in each RPC. Has value 1 for non-streaming RPCs.", stats.UnitDimensionless)
	serverSentBytesPerRPC               = stats.Int64("grpcforunconflict.io/server/sent_bytes_per_rpc", "Total bytes sent in across all response messages per RPC.", stats.UnitBytes)
	serverSentCompressedBytesPerRPC     = stats.Int64("grpcforunconflict.io/server/sent_compressed_bytes_per_rpc", "Total compressed bytes sent in across all response messages per RPC.", stats.UnitBytes)
	serverStartedRPCs                   = stats.Int64("grpcforunconflict.io/server/started_rpcs", "The total number of server RPCs ever opened, including those that have not completed.", stats.UnitDimensionless)
	serverLatency                       = stats.Float64("grpcforunconflict.io/server/server_latency", "Time between first byte of request received to last byte of response sent, or terminal error.", stats.UnitMilliseconds)
)
...
var (
	...
	ServerSentMessagesPerRPCView = &view.View{
		Name:        "grpcforunconflict.io/server/sent_messages_per_rpc",
	...
	ServerReceivedMessagesPerRPCView = &view.View{
		Name:        "grpcforunconflict.io/server/received_messages_per_rpc",
	...
	ServerSentBytesPerRPCView = &view.View{
		Name:        "grpcforunconflict.io/server/sent_bytes_per_rpc",
	...
	ServerSentCompressedMessageBytesPerRPCView = &view.View{
		Name:        "grpcforunconflict.io/server/sent_compressed_message_bytes_per_rpc",
	...
	ServerReceivedBytesPerRPCView = &view.View{
		Name:        "grpcforunconflict.io/server/received_bytes_per_rpc",
	...
	ServerReceivedCompressedMessageBytesPerRPCView = &view.View{
		Name:        "grpcforunconflict.io/server/received_compressed_message_bytes_per_rpc",
	...
	ServerStartedRPCsView = &view.View{
		...
		Name:        "grpcforunconflict.io/server/started_rpcs",
	...
	ServerCompletedRPCsView = &view.View{
		Name:        "grpcforunconflict.io/server/completed_rpcs",
	...
	ServerLatencyView = &view.View{
		Name:        "grpcforunconflict.io/server/server_latency",
