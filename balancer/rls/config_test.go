...
import (
	...
	_ "github.com/qiyouForSql/grpcforunconflict/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/qiyouForSql/grpcforunconflict/internal/resolver/passthrough" // passthrough resolver.
)
