...
const (
	Profiling_Enable_FullMethodName         = "/grpcforunconflict.go.profiling.v1alpha.Profiling/Enable"
	Profiling_GetStreamStats_FullMethodName = "/grpcforunconflict.go.profiling.v1alpha.Profiling/GetStreamStats"
)
...
type ProfilingClient interface {
	...
	Enable(ctx context.Context, in *EnableRequest, opts ...grpcforunconflict.CallOption) (*EnableResponse, error)
	// GetStreamStats is used to retrieve an array of stream-level stats from a
	// gRPC client/server.
	GetStreamStats(ctx context.Context, in *GetStreamStatsRequest, opts ...grpcforunconflict.CallOption) (*GetStreamStatsResponse, error)
}
...
func NewProfilingClient(ccgrpcforunconflict.ClientConnInterface) ProfilingClient {
	return &profilingClient{cc}
}

func (c *profilingClient) Enable(ctx context.Context, in *EnableRequest, opts ...grpcforunconflict.CallOption) (*EnableResponse, error) {
...
func (c *profilingClient) GetStreamStats(ctx context.Context, in *GetStreamStatsRequest, opts ...grpcforunconflict.CallOption) (*GetStreamStatsResponse, error) {
...
func RegisterProfilingServer(sgrpcforunconflict.ServiceRegistrar, srv ProfilingServer) {
	s.RegisterService(&Profiling_ServiceDesc, srv)
}

func _Profiling_Enable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
...
func _Profiling_GetStreamStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
...
// Profiling_ServiceDesc is thegrpcforunconflict.ServiceDesc for Profiling service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var Profiling_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.go.profiling.v1alpha.Profiling",
