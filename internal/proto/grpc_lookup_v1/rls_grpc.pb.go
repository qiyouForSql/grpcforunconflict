...
const (
	RouteLookupService_RouteLookup_FullMethodName = "/grpcforunconflict.lookup.v1.RouteLookupService/RouteLookup"
)
...
type RouteLookupServiceClient interface {
	...
	RouteLookup(ctx context.Context, in *RouteLookupRequest, opts ...grpcforunconflict.CallOption) (*RouteLookupResponse, error)
}
...
func NewRouteLookupServiceClient(ccgrpcforunconflict.ClientConnInterface) RouteLookupServiceClient {
	return &routeLookupServiceClient{cc}
}

func (c *routeLookupServiceClient) RouteLookup(ctx context.Context, in *RouteLookupRequest, opts ...grpcforunconflict.CallOption) (*RouteLookupResponse, error) {
...
func RegisterRouteLookupServiceServer(sgrpcforunconflict.ServiceRegistrar, srv RouteLookupServiceServer) {
	s.RegisterService(&RouteLookupService_ServiceDesc, srv)
}

func _RouteLookupService_RouteLookup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
...
// RouteLookupService_ServiceDesc is thegrpcforunconflict.ServiceDesc for RouteLookupService service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var RouteLookupService_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.lookup.v1.RouteLookupService",
