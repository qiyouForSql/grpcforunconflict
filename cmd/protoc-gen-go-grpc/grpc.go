...
const (
	...
	grpcPackage    = protogen.GoImportPath("github.com/qiyouForSql/grpcforunconflict")
...
// generateFile generates a _grpcforunconflict.pb.go file containing gRPC service definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	if len(file.Services) == 0 {
		return nil
	}
	filename := file.GeneratedFilenamePrefix + "_grpcforunconflict.pb.go"
	...
	g.P("// Code generated by protoc-gen-go-grpcforunconflict. DO NOT EDIT.")
	g.P("// versions:")
