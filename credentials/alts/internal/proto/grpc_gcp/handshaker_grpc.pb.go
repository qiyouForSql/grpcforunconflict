...
const (
	HandshakerService_DoHandshake_FullMethodName = "/grpcforunconflict.gcp.HandshakerService/DoHandshake"
)
...
type HandshakerServiceClient interface {
	...
	DoHandshake(ctx context.Context, opts ...grpcforunconflict.CallOption) (HandshakerService_DoHandshakeClient, error)
}
...
func NewHandshakerServiceClient(ccgrpcforunconflict.ClientConnInterface) HandshakerServiceClient {
	return &handshakerServiceClient{cc}
}

func (c *handshakerServiceClient) DoHandshake(ctx context.Context, opts ...grpcforunconflict.CallOption) (HandshakerService_DoHandshakeClient, error) {
...
func RegisterHandshakerServiceServer(sgrpcforunconflict.ServiceRegistrar, srv HandshakerServiceServer) {
	s.RegisterService(&HandshakerService_ServiceDesc, srv)
}

func _HandshakerService_DoHandshake_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
// HandshakerService_ServiceDesc is thegrpcforunconflict.ServiceDesc for HandshakerService service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var HandshakerService_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.gcp.HandshakerService",
