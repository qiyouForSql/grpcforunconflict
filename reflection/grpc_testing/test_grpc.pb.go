...
const (
	SearchService_Search_FullMethodName          = "/grpcforunconflict.testing.SearchService/Search"
	SearchService_StreamingSearch_FullMethodName = "/grpcforunconflict.testing.SearchService/StreamingSearch"
)
...
type SearchServiceClient interface {
	Search(ctx context.Context, in *SearchRequest, opts ...grpcforunconflict.CallOption) (*SearchResponse, error)
	StreamingSearch(ctx context.Context, opts ...grpcforunconflict.CallOption) (SearchService_StreamingSearchClient, error)
}
...
func NewSearchServiceClient(ccgrpcforunconflict.ClientConnInterface) SearchServiceClient {
	return &searchServiceClient{cc}
}

func (c *searchServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpcforunconflict.CallOption) (*SearchResponse, error) {
...
func (c *searchServiceClient) StreamingSearch(ctx context.Context, opts ...grpcforunconflict.CallOption) (SearchService_StreamingSearchClient, error) {
...
func RegisterSearchServiceServer(sgrpcforunconflict.ServiceRegistrar, srv SearchServiceServer) {
	s.RegisterService(&SearchService_ServiceDesc, srv)
}

func _SearchService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
...
func _SearchService_StreamingSearch_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
// SearchService_ServiceDesc is thegrpcforunconflict.ServiceDesc for SearchService service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var SearchService_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.testing.SearchService",
