...
const (
	ServerReflection_ServerReflectionInfo_FullMethodName = "/grpcforunconflict.reflection.v1alpha.ServerReflection/ServerReflectionInfo"
)
...
type ServerReflectionClient interface {
	...
	ServerReflectionInfo(ctx context.Context, opts ...grpcforunconflict.CallOption) (ServerReflection_ServerReflectionInfoClient, error)
}
...
func NewServerReflectionClient(ccgrpcforunconflict.ClientConnInterface) ServerReflectionClient {
	return &serverReflectionClient{cc}
}

func (c *serverReflectionClient) ServerReflectionInfo(ctx context.Context, opts ...grpcforunconflict.CallOption) (ServerReflection_ServerReflectionInfoClient, error) {
...
func RegisterServerReflectionServer(sgrpcforunconflict.ServiceRegistrar, srv ServerReflectionServer) {
	s.RegisterService(&ServerReflection_ServiceDesc, srv)
}

func _ServerReflection_ServerReflectionInfo_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
// ServerReflection_ServiceDesc is thegrpcforunconflict.ServiceDesc for ServerReflection service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var ServerReflection_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.reflection.v1alpha.ServerReflection",
