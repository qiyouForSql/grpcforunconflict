...
const (
	Echo_UnaryEcho_FullMethodName                  = "/grpcforunconflict.examples.echo.Echo/UnaryEcho"
	Echo_ServerStreamingEcho_FullMethodName        = "/grpcforunconflict.examples.echo.Echo/ServerStreamingEcho"
	Echo_ClientStreamingEcho_FullMethodName        = "/grpcforunconflict.examples.echo.Echo/ClientStreamingEcho"
	Echo_BidirectionalStreamingEcho_FullMethodName = "/grpcforunconflict.examples.echo.Echo/BidirectionalStreamingEcho"
)
...
type EchoClient interface {
	...
	UnaryEcho(ctx context.Context, in *EchoRequest, opts ...grpcforunconflict.CallOption) (*EchoResponse, error)
	// ServerStreamingEcho is server side streaming.
	ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpcforunconflict.CallOption) (Echo_ServerStreamingEchoClient, error)
	// ClientStreamingEcho is client side streaming.
	ClientStreamingEcho(ctx context.Context, opts ...grpcforunconflict.CallOption) (Echo_ClientStreamingEchoClient, error)
	// BidirectionalStreamingEcho is bidi streaming.
	BidirectionalStreamingEcho(ctx context.Context, opts ...grpcforunconflict.CallOption) (Echo_BidirectionalStreamingEchoClient, error)
}
...
func NewEchoClient(ccgrpcforunconflict.ClientConnInterface) EchoClient {
	return &echoClient{cc}
}

func (c *echoClient) UnaryEcho(ctx context.Context, in *EchoRequest, opts ...grpcforunconflict.CallOption) (*EchoResponse, error) {
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpcforunconflict.CallOption) (Echo_ServerStreamingEchoClient, error) {
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpcforunconflict.CallOption) (Echo_ClientStreamingEchoClient, error) {
...
func (c *echoClient) BidirectionalStreamingEcho(ctx context.Context, opts ...grpcforunconflict.CallOption) (Echo_BidirectionalStreamingEchoClient, error) {
...
func RegisterEchoServer(sgrpcforunconflict.ServiceRegistrar, srv EchoServer) {
	s.RegisterService(&Echo_ServiceDesc, srv)
}

func _Echo_UnaryEcho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
...
func _Echo_ServerStreamingEcho_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
	m := new(EchoRequest)
...
func _Echo_ClientStreamingEcho_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
func _Echo_BidirectionalStreamingEcho_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
// Echo_ServiceDesc is thegrpcforunconflict.ServiceDesc for Echo service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var Echo_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.examples.echo.Echo",
