...
const (
	WorkerService_RunServer_FullMethodName  = "/grpcforunconflict.testing.WorkerService/RunServer"
	WorkerService_RunClient_FullMethodName  = "/grpcforunconflict.testing.WorkerService/RunClient"
	WorkerService_CoreCount_FullMethodName  = "/grpcforunconflict.testing.WorkerService/CoreCount"
	WorkerService_QuitWorker_FullMethodName = "/grpcforunconflict.testing.WorkerService/QuitWorker"
)
...
type WorkerServiceClient interface {
	...
	// this RPC.
	RunServer(ctx context.Context, opts ...grpcforunconflict.CallOption) (WorkerService_RunServerClient, error)
	...
	// and once the shutdown has finished, the OK status is sent to terminate
	// this RPC.
	RunClient(ctx context.Context, opts ...grpcforunconflict.CallOption) (WorkerService_RunClientClient, error)
	// Just return the core count - unary call
	CoreCount(ctx context.Context, in *CoreRequest, opts ...grpcforunconflict.CallOption) (*CoreResponse, error)
	// Quit this worker
	QuitWorker(ctx context.Context, in *Void, opts ...grpcforunconflict.CallOption) (*Void, error)
}
...
func NewWorkerServiceClient(ccgrpcforunconflict.ClientConnInterface) WorkerServiceClient {
	return &workerServiceClient{cc}
}

func (c *workerServiceClient) RunServer(ctx context.Context, opts ...grpcforunconflict.CallOption) (WorkerService_RunServerClient, error) {
...
func (c *workerServiceClient) RunClient(ctx context.Context, opts ...grpcforunconflict.CallOption) (WorkerService_RunClientClient, error) {
...
func (c *workerServiceClient) CoreCount(ctx context.Context, in *CoreRequest, opts ...grpcforunconflict.CallOption) (*CoreResponse, error) {
...
func (c *workerServiceClient) QuitWorker(ctx context.Context, in *Void, opts ...grpcforunconflict.CallOption) (*Void, error) {
	out := new(Void)
...
func RegisterWorkerServiceServer(sgrpcforunconflict.ServiceRegistrar, srv WorkerServiceServer) {
	s.RegisterService(&WorkerService_ServiceDesc, srv)
}

func _WorkerService_RunServer_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
func _WorkerService_RunClient_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
func _WorkerService_CoreCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
	in := new(CoreRequest)
...
func _WorkerService_QuitWorker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
	in := new(Void)
	if err := dec(in); err != nil {
		return nil, err
	}
...
// WorkerService_ServiceDesc is thegrpcforunconflict.ServiceDesc for WorkerService service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var WorkerService_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.testing.WorkerService",
