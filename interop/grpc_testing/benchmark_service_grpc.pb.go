...
const (
	BenchmarkService_UnaryCall_FullMethodName           = "/grpcforunconflict.testing.BenchmarkService/UnaryCall"
	BenchmarkService_StreamingCall_FullMethodName       = "/grpcforunconflict.testing.BenchmarkService/StreamingCall"
	BenchmarkService_StreamingFromClient_FullMethodName = "/grpcforunconflict.testing.BenchmarkService/StreamingFromClient"
	BenchmarkService_StreamingFromServer_FullMethodName = "/grpcforunconflict.testing.BenchmarkService/StreamingFromServer"
	BenchmarkService_StreamingBothWays_FullMethodName   = "/grpcforunconflict.testing.BenchmarkService/StreamingBothWays"
)
...
type BenchmarkServiceClient interface {
	...
	StreamingCall(ctx context.Context, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingCallClient, error)
	// Single-sided unbounded streaming from client to server
	// The server returns the client payload as-is once the client does WritesDone
	StreamingFromClient(ctx context.Context, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingFromClientClient, error)
	// Single-sided unbounded streaming from server to client
	// The server repeatedly returns the client payload as-is
	StreamingFromServer(ctx context.Context, in *SimpleRequest, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingFromServerClient, error)
	// Two-sided unbounded streaming between server to client
	// Both sides send the content of their own choice to the other
	StreamingBothWays(ctx context.Context, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingBothWaysClient, error)
}
...
func NewBenchmarkServiceClient(ccgrpcforunconflict.ClientConnInterface) BenchmarkServiceClient {
	return &benchmarkServiceClient{cc}
}

func (c *benchmarkServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpcforunconflict.CallOption) (*SimpleResponse, error) {
...
func (c *benchmarkServiceClient) StreamingCall(ctx context.Context, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingCallClient, error) {
...
func (c *benchmarkServiceClient) StreamingFromClient(ctx context.Context, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingFromClientClient, error) {
...
func (c *benchmarkServiceClient) StreamingFromServer(ctx context.Context, in *SimpleRequest, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingFromServerClient, error) {
...
func (c *benchmarkServiceClient) StreamingBothWays(ctx context.Context, opts ...grpcforunconflict.CallOption) (BenchmarkService_StreamingBothWaysClient, error) {
...
func RegisterBenchmarkServiceServer(sgrpcforunconflict.ServiceRegistrar, srv BenchmarkServiceServer) {
	s.RegisterService(&BenchmarkService_ServiceDesc, srv)
}

func _BenchmarkService_UnaryCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptorgrpcforunconflict.UnaryServerInterceptor) (interface{}, error) {
...
func _BenchmarkService_StreamingCall_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
func _BenchmarkService_StreamingFromClient_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
func _BenchmarkService_StreamingFromServer_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
	m := new(SimpleRequest)
...
func _BenchmarkService_StreamingBothWays_Handler(srv interface{}, streamgrpcforunconflict.ServerStream) error {
...
// BenchmarkService_ServiceDesc is thegrpcforunconflict.ServiceDesc for BenchmarkService service.
// It's only intended for direct use withgrpcforunconflict.RegisterService,
// and not to be introspected or modified (even as a copy)
var BenchmarkService_ServiceDesc =grpcforunconflict.ServiceDesc{
	ServiceName: "grpcforunconflict.testing.BenchmarkService",
